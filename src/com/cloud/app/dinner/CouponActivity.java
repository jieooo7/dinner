...
//		将list写入本地
		...
		DebugUtil.i("test....head","11111----"+mp.getBackHead().get("code"));
		DebugUtil.i("test....para","22222----"+mp.getBackPara().get("total"));
		DebugUtil.i("test....result","33333----"+mp.getBackResult().get(1).get("goods_no"));
		DebugUtil.i("test....resultimg","img----"+mp.getBackResult().get(1).get("img_url"));
		}catch(Exception  e){
...
//		}
//		
//		SimpleAdapter adapterDefault=new SimpleAdapter(this, list, R.layout.gcoupon, item, itemId);
//		
